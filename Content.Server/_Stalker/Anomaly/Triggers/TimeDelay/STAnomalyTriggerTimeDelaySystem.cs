...
public sealed class STAnomalyTriggerTimeDelaySystem : EntitySystem
{
    ...
    private struct ActivationQueueElement(EntityUid anomaly, TimeSpan time, STAnomalyTriggerTimeDelayOptions options)
    {
        public readonly EntityUid Anomaly = anomaly;
        public readonly TimeSpan Time = time;
        public readonly STAnomalyTriggerTimeDelayOptions Options = options;
    }
}
